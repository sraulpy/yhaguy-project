...
//todo esto es para poder acceder de forma fácil a las columnas de los datos
	...
	static String[] colNombreDet1 = { "IDARTICULO", "DESCRIPCION","CODIGO_FABRICA" ,"CODIGO_BARRA" ,"CODIGO_ORIGINAL","IDMARCA" , "MARCA" , "IDPARTE", "PARTE" ,"IDMARCA_APLICACION" , "MARCA_APLICACION" , "IDMODELO_APLICACION" , "MODELO_APLICACION" , "IDFAMILIA" ,"FAMILIA" ,"IDLINEA" ,"LINEA" , "ESTADO" , "IDCOLECCION","COLECCION" , "FECHA_ALTA"};
	
	
	static String FAMILIA_DEFAULT   = "SIN FAMILIA";
	static String FAMILIA_REPUESTOS = "REPUESTOS";

	public static void migrarDatos1() throws Exception {
   ...
   public static String kahvecicsv = "./WEB-INF/docs/migracion/articulos/kahveci.csv";

	// ========================================================
	// todo esto es para poder acceder de forma fácil a las columnas de los datos
	
	static String[] colNombreDet = { "CODIGO_PROVEEDOR", "CODIGO_ORIGINAL","DESCRIPCION_ARTICULO" ,"TIPO_MOTOR" ,"MARCA_APLICACION" };
	...
	public static void migrarDatos() throws Exception {
		...
		while (archivo.ready() == true) {
			...
			String CODIGOPROVEEDOR = getDato("CODIGO_PROVEEDOR", datos);
			String CODIGOORIGINAL = getDato("CODIGO_ORIGINAL", datos);
			String DESCRIPCIONARTICULO = getDato("DESCRIPCION_ARTICULO", datos);
			String TIPOMOTOR = getDato("TIPO_MOTOR", datos);
			String MARCAAPLICACION= getDato("MARCA_APLICACION", datos);

			System.out.println(i + ") " + CODIGOPROVEEDOR + " - " +  CODIGOORIGINAL+" - "+DESCRIPCIONARTICULO+" - "+TIPOMOTOR+" - "+MARCAAPLICACION );
		}
	}
