...
public class FuncionarioPopupSucuViewModel extends SoloViewModel {

	private FuncionarioControlBody dato;

	@AfterCompose(superclass = true)
	public void afterFuncionarioPopupSucuViewModel() {
	}

	@Init(superclass = true)
	public void initFuncionarioPopupSucuViewModel(@ExecutionArgParam("dato") FuncionarioControlBody dato) {
		this.dato = dato;
	}
	...
	@NotifyChange("*")
	@Command
	public void actualizarSucursalesHabilitadas() {
