...
public class ReporteProveedoresDepuracion extends ReporteYhaguy {
	...
	static DatosColumnas col1 = new DatosColumnas("RUC", TIPO_STRING, 25);
	static DatosColumnas col2 = new DatosColumnas("Razón Social", TIPO_STRING, 60);
	static DatosColumnas col3 = new DatosColumnas("Ult. Mod.", TIPO_DATE, 23);
	static DatosColumnas col4 = new DatosColumnas("PRI", TIPO_LONG, 10);
	static DatosColumnas col5 = new DatosColumnas("COMP", TIPO_BOOLEAN, 15);
	static DatosColumnas col6 = new DatosColumnas("Observación", TIPO_STRING, 100);
	...
	public void informacionReporte() {
		...
		// titulo del reporte
		this.setTitulo("LISTADO DE PROVEEDORES - PARA DEPURACIÓN");

		// archivo de salida
		this.setDirectorio("/Proveedores/");
		this.setNombreArchivo("proveedor");
	...
	public void reportePrioridad(Date fechaDesde, Date fechaHasta,
		...
		if (completo == true) {
			whereCompleto = "AND pro.completo='true'";
			this.completo = "SI";
		}

		String orden = "order by emp.razonSocial";
		if (prioridad == true) {
			orden = "order by pro.prioridad";
			this.prioridad = "SI";
		}
		
		String consulta = " "
				+ " select pro.id , emp.ruc , emp.razonSocial , emp.modificado , pro.prioridad , pro.completo , emp.observacion "
				+ " from  Proveedor pro join pro.empresa emp "
	...
	public static void main(String[] args) throws Exception {
		...
		ReporteProveedoresDepuracion dr = new ReporteProveedoresDepuracion();
