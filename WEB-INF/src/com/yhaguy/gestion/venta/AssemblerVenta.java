...
public class AssemblerVenta extends Assembler {
	...
	private static String[] attIgualesVenta = { "idEnlaceSiguiente", "fecha", "vencimiento", "cuotas", "numero",
			...
			"denominacion", "validez", "formaEntrega", "cartera", "numeroReparto" };
	...
	private static String[] attCliente = { "codigoEmpresa", "razonSocial", "ruc", "idEmpresa", "tipoCliente",
			...
			"descuentoMayorista", "cartera", "ventaExenta" };
	...
	public Domain dtoToDomain(DTO dtoP) throws Exception {
		...
		this.myArrayToDomain(dto, domain, "tecnico");
	...
	public DTO domainToDto(Domain domain) throws Exception {
		...
		this.domainToMyArray(domain, dto, "tecnico", new String[] { "tecnico" });
