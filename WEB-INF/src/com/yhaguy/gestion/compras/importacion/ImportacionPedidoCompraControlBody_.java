...
public class ImportacionPedidoCompraControlBody_ extends Control {

	public ImportacionPedidoCompraControlBody_() {
		super(null);
	}

	public ImportacionPedidoCompraControlBody_(Assembler ass) {
		super(ass);
	}
