package com.yhaguy.gestion.contable.librocompras;
...
public class LibroComprasForward extends SimpleViewModel {
	
	@Wire
	private Iframe if_rep;

	@Init(superclass = true)
	public void init(@ExecutionParam("cod") String cod) {
		this.setAtributoSession("COD_REPORTE", cod);
	}
