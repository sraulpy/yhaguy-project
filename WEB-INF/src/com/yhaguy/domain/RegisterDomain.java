...
public class RegisterDomain extends Register {
	...
	/**
	 * @return las remisiones anuladas segun fecha
	 */
	public List<Remision> getRemisionesAnuladas(Date desde, Date hasta) throws Exception {

		String query = "select n from Remision n where n.dbEstado != 'D'"
				+ " and n.estadoComprobante.sigla = '" + Configuracion.SIGLA_ESTADO_COMPROBANTE_ANULADO + "'"
				+ " and (n.fecha between ? and ?)";
		query += " order by n.numero";
	 ...
	 */
	public List<NotaCredito> getNotasCreditoVenta(Date desde, Date hasta) throws Exception {

		String query = "select n from NotaCredito n where n.tipoMovimiento.sigla = ?"
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getVentasPorArticuloCosto(long idArticulo, Date desde, Date hasta, boolean fechaHora) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		...
		String query = "select v.tipoMovimiento.descripcion, v.fecha, v.numero, d.cantidad, d.costoPromedioGs, v.cliente.empresa.razonSocial,"
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getVentasPorArticuloCosto(long idArticulo, Date desde, Date hasta, boolean fechaHora, long idSucursal) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = fechaHora ? Utiles.getDateToString(hasta, "yyyy-MM-dd HH:mm:ss") : misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:59";
		String query = "select v.tipoMovimiento.descripcion, v.fecha, v.numero, d.cantidad, d.costoPromedioGs, v.cliente.empresa.razonSocial,"
				+ " v.deposito.descripcion, d.articulo.codigoInterno, d.articulo.descripcion, '- - -',"
	...
	public List<Object[]> getVentasPorArticulo(long idArticulo, Date desde, Date hasta) throws Exception {
		return this.getVentasPorArticulo(idArticulo, desde, hasta, false);
	}
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getVentasPorArticulo(long idArticulo, Date desde, Date hasta, boolean fechaHora) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = fechaHora ? Utiles.getDateToString(hasta, "yyyy-MM-dd HH:mm:ss") : misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:59";
	...
	public List<Object[]> getNotasCreditoCompraPorArticulo(long idArticulo,
			Date desde, Date hasta) throws Exception {
		return this.getNotasCreditoCompraPorArticulo(idArticulo, desde, hasta, false);
	}
	...
	public List<Object[]> getTransferenciasPorArticuloMRAentrada(long idArticulo,
			Date desde, Date hasta) throws Exception {
		return this.getTransferenciasPorArticuloMRAentrada(idArticulo, desde, hasta, false);
	}
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getTransferenciasPorArticuloMRAingreso(long idArticulo,
	...
	public List<Object[]> getTransferenciasPorArticuloMRAsalida(long idArticulo,
			Date desde, Date hasta) throws Exception { 
		return this.getTransferenciasPorArticuloMRAsalida(idArticulo, desde, hasta, false);
	}
	...
	public List<Object[]> getTransferenciasPorArticulo(long idArticulo,
			Date desde, Date hasta) throws Exception {
		return this.getTransferenciasPorArticulo(idArticulo, desde, hasta, false);
	}
	...
	public List<Object[]> getTransferenciasPorArticulo(long idArticulo,
		...
		String query = "select t.transferenciaTipo.descripcion, t.fechaCreacion, t.numero, d.cantidad, d.costo, t.sucursalDestino.descripcion, t.sucursal.id,"
				...
				+ hasta_
				+ "') and t.sucursalDestino.id = " + SucursalApp.ID_MRA
				+ " and t.sucursal.id = " + idSucursal + " order by t.fechaCreacion desc";
		return this.hql(query);
	}
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getTransferenciasPorArticuloDestinoAUT(long idArticulo,
			Date desde, Date hasta, boolean fechaHora) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = fechaHora ? Utiles.getDateToString(hasta, "yyyy-MM-dd HH:mm:ss") : misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:59";
		String query = "select t.transferenciaTipo.descripcion, t.fechaCreacion, t.numero, d.cantidad, d.costo, t.sucursalDestino.descripcion, t.sucursal.id,"
				+ " t.depositoSalida.id, t.depositoEntrada.id, '--', '--', '--', t.sucursal.descripcion"
				+ " from Transferencia t join t.detalles d where t.dbEstado != 'D' and d.articulo.id = "
				+ idArticulo
				+ " and (t.transferenciaTipo.sigla = '"
				+ Configuracion.ID_TIPO_TRANSFERENCIA_EXTERNA
				+ "')"
				...
				+ "' and t.fechaCreacion <= '"
				+ hasta_
				+ "') and t.sucursalDestino.id = " + SucursalApp.ID_AUTOCENTRO
				+ " and t.sucursal.id = " + SucursalApp.ID_CENTRAL + " order by t.fechaCreacion desc";
		return this.hql(query);
	}
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getTransferenciasPorArticuloDestinoDiferenciaInv2019(long idArticulo,
			Date desde, Date hasta, boolean fechaHora) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = fechaHora ? Utiles.getDateToString(hasta, "yyyy-MM-dd HH:mm:ss") : misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:59";
	 ...
	 * [12]:sucursal
	 */
	public List<Object[]> getTransferenciasPorArticuloOrigenAUT(long idArticulo,
			Date desde, Date hasta, boolean fechaHora) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = fechaHora ? Utiles.getDateToString(hasta, "yyyy-MM-dd HH:mm:ss") : misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:59";
		String query = "select t.transferenciaTipo.descripcion, t.fechaCreacion, t.numero, d.cantidad, d.costo, t.sucursalDestino.descripcion, t.sucursal.id,"
				...
				+ "' and t.fechaCreacion <= '"
				+ hasta_
				+ "') and t.sucursal.id = " + SucursalApp.ID_AUTOCENTRO
				+ " and t.sucursalDestino.id IN (" + SucursalApp.ID_CENTRAL + ", " + SucursalApp.ID_GAM + ", " + SucursalApp.ID_MCAL + ") order by t.fechaCreacion desc";
		return this.hql(query);
	}
	...
	public List<Object[]> getComprasLocalesPorArticulo(long idArticulo,
			Date desde, Date hasta) throws Exception {
		return this.getComprasLocalesPorArticulo(idArticulo, desde, hasta, false);
	}
	...
	public List<Object[]> getComprasImportacionPorArticulo(long idArticulo,
			Date desde, Date hasta) throws Exception {
		return this.getComprasImportacionPorArticulo(idArticulo, desde, hasta, false);
	}
	...
	public List<Object[]> getAjustesPorArticulo(long idArticulo, Date desde,
		...
		return this.getAjustesPorArticulo(idArticulo, desde, hasta, idSucursal, tipo, false);
	}
	 ...
	 */
	public List<Object[]> getAjustesPorArticulo(long idArticulo, Date desde,
			Date hasta, long idSucursal, String tipo, boolean fechaHora) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = fechaHora ? Utiles.getDateToString(hasta, "yyyy-MM-dd HH:mm:ss") : misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:59";
		String query = "";
	 ...
	 * @return los ajustes donde esta contenida el articulo..
	 */
	public List<Object[]> getAjustesPorArticuloStockValorizado(long idArticulo, Date desde,
			Date hasta, long idSucursal, String tipo) throws Exception {
		return this.getAjustesPorArticuloStockValorizado(idArticulo, desde, hasta, idSucursal, tipo, false);
	}
	 ...
	 * [9]:respuestaSet
	 */
	public List<Object[]> getSifenRemisiones(Date desde, Date hasta) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:00";
	...
	/**
	 * migracion del articulo [0]:id [1]:concepto [2]:fecha [3]:numero
	 */
	public List<Object[]> getMigraciones(Date desde, Date hasta) throws Exception {
		String desde_ = misc.dateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = misc.dateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:00";
		String query = "select a.id, 'MIGRACION', a.fechaAlta, '--'"
				+ " from ArticuloHistorialMigracion a where a.dbEstado != 'D'";
		if (desde != null) {
			query += " and (a.fechaAlta >= '" + desde_ + "' and a.fechaAlta <= '" + hasta_ + "')";
		}
		List<Object[]> out = this.hql(query);
	 ...
	 * [18]:empresa.cuentaBloqueada
	 * [19]:empresa.vendedor.razonSocial
	 */
	 ...
	 * [17]:cliente.limiteCredito
	 */
	public List<Object[]> getSaldos2019(Date desde, Date hasta, String caracter, long idVendedor, long idEmpresa, long idMoneda, long idCartera) throws Exception {
		String desde_ = Utiles.getDateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = Utiles.getDateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:00";
		String query = "select c.idMovimientoOriginal, c.tipoMovimiento.id, c.nroComprobante, c.tipoMovimiento.descripcion, e.telefono_, e.direccion_, c.fechaEmision, c.fechaVencimiento, c.importeOriginal, "
				+ " (select sum(saldo) from CtaCteEmpresaMovimiento_2019 m where m.idMovimientoOriginal = c.idMovimientoOriginal and m.tipoMovimiento.id = c.tipoMovimiento.id ),"
				+ " e.razonSocial, e.ruc, c.saldo, c.tipoMovimiento.sigla, e.id, c.carteraCliente.id, c.carteraCliente.descripcion,"
				+ " (select cl.limiteCredito from Cliente cl where cl.empresa.id = e.id)"
				+ " from CtaCteEmpresaMovimiento_2019 c, Empresa e"
				+ " where c.idEmpresa = e.id and c.anulado = 'FALSE' and c.saldo > 0 and"
				+ " c.tipoCaracterMovimiento.sigla = '"
				+ caracter
				+ "'"
	 ...
	 * obtener depositos
	 */
	public List<Deposito> getDepositosVirtuales() throws Exception {
		String query = "select d from Deposito d where d.dbEstado != 'D' and d.dbEstado = 'V' and d.auxi != 'NO_AUDIT' order by d.descripcion";
		return (List<Deposito>) this.hql(query);
	}
	 ...
	 * @return el costo promedio del articulo..
	 */
	public double getCostoUltimo(long idArticulo, Date fecha) throws Exception {
		String fecha_ = Utiles.getDateToString(fecha, Misc.YYYY_MM_DD) + " 23:59:00";
		String query = "select a from ArticuloCostoPromediogs a where a.articulo.id = " + idArticulo
				+ " and a.fecha <= '" + fecha_ + "' order by a.fecha desc";
		List<ArticuloCostoPromediogs> list = this.hqlLimit(query, 1);
		if (list.size() > 0) {
			double out = list.get(0).getUltimoCosto();
			return Utiles.getRedondeo(out / list.size());		
		} else {
			return 0.0;
		}
	...
	/**
	 * @return los ingresos bancarios..
	 */
	public List<BancoIngreso> getBancoIngresos(String fecha, String banco, String numero, String concepto) throws Exception {
		String query = "select b from BancoIngreso b where "
				+ " upper(b.numero) like '%" + numero.toUpperCase() + "%'"
				+ " and cast (b.fecha as string) like '%" + fecha + "%'"
				+ " and upper(b.banco.banco.descripcion) like '%" + banco.toUpperCase() + "%'"
	 ...
	 * [6]:fechaAcreditacion
	 */
	public List<Object[]> getDepositosPorBancoAconfirmar(long idBanco, Date desde, Date hasta) throws Exception {
		String desde_ = Utiles.getDateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = Utiles.getDateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:00";
		String query = "select (select descripcion from TipoMovimiento where sigla = '" + Configuracion.SIGLA_TM_DEPOSITO_BANCARIO + "'), "
				+ " b.fecha, b.numeroBoleta, b.totalImporte_gs, b.nroCuenta.banco.descripcion, b.observacion, b.fechaAcreditacion"
				+ " from BancoBoletaDeposito b where b.fecha < b.fechaAcreditacion"
				+ " and b.dbEstado != 'D'"
				+ " and b.nroCuenta.id = " + idBanco
				+ " and (b.fecha >= '"
				+ desde_
	 ...
	 * [4]:banco 
	 */
	public List<Object[]> getPrestamosInternosApagar(long idBanco, Date desde, Date hasta) throws Exception {
		String desde_ = Utiles.getDateToString(desde, Misc.YYYY_MM_DD) + " 00:00:00";
		String hasta_ = Utiles.getDateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:00";
		String query = "select ('PRESTAMOS INTERNOS'), "
				+ " b.fecha, cast(b.id as string), b.totalImporte_gs, b.banco.banco.descripcion, b.observacion"
	...
	public List<Object[]> getFormasPagoDepositoBancarioEnRecibosPorBanco(long idBanco, Date desde, Date hasta) throws Exception {
		...
		String query = "select ('DEPOSITO CTA. BANCARIA'), "
				+ " f.fechaOperacion, f.depositoNroReferencia,"
				+ " (CASE WHEN f.moneda.sigla = '" + Configuracion.SIGLA_MONEDA_GUARANI + "' THEN f.montoGs ELSE f.montoDs END),"
				+ " f.depositoBancoCta.banco.descripcion, concat('RECIBO NRO. ', r.numero, ' - ', r.cliente.empresa.razonSocial)"
	...
	public List<Object[]> getArticulos(String codigoInterno, String descripcion) throws Exception {
		String query = "select a.id, a.codigoInterno, a.descripcion, a.costoGs from Articulo a where "
	 ...
	 * [3]:costo
	 */
	public List<Object[]> getArticulosMercaderias(String codigoInterno, String descripcion, String familias) throws Exception {
		String query = "select a.id, a.codigoInterno, a.descripcion, a.costoGs from Articulo a where "
				+ "upper(a.codigoInterno) = '" + codigoInterno.toUpperCase() + "' and "
				+ "upper(a.descripcion) like '%" + descripcion.toUpperCase() + "%' "
				+ "order by a.codigoInterno";
		return this.hql(query);
	}
	...
	public Object[] getArticulo_(long idArticulo) throws Exception {
		String query = "select a.id, a.codigoInterno, a.precioListaGs, a.precioMinoristaGs, a.precioGs, a.precioDs,"
				+ "a.porcentajeDescuento, a.precioTransportadora, a.precioBaterias, a.precioPromocion, a.precioMayoristaContadoGs, a.familia.descripcion"
	...
	public long getStockArticulo(long idArticulo) throws Exception {
		String query = "select sum(stock) from ArticuloDeposito a where a.deposito.dbEstado != 'V' and a.articulo.id = " + idArticulo;
	...
	public List<Object[]> getVentasCreditoPorCliente_(Date desde, Date hasta, long idCliente) throws Exception {
		...
		String hasta_ = Utiles.getDateToString(hasta, Misc.YYYY_MM_DD) + " 23:59:00";
		String query = "SELECT v.cliente.id, v.cliente.empresa.razonSocial, " +
				"  sum(v.totalImporteGs), TO_CHAR(v.fecha,'MM')" +   
				"	FROM Venta v" +
				"	WHERE (v.fecha >= '" + desde_ + "' and v.fecha <= '" + hasta_ + "')" + 
				"      AND v.tipoMovimiento.sigla = '" + Configuracion.SIGLA_TM_FAC_VENTA_CREDITO + "'" + 
				"      AND v.dbEstado != 'D' AND v.estadoComprobante IS NULL" +
